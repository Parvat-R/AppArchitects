...
class Database:
    ...
    def newSession(self, farmerID, deviceDetails):
        return self.execute(
            """
                INSERT INTO session (farmerID, deviceDetails) values ( ?, ? );
            """,
            (farmerID, deviceDetails)
        )

    def getSessionID(self, farmerID, deviceDetails):
    ...
    def sessionIsValid(self, farmerID, sessionID, deviceDetails):
        return self.DB.execute(
            """
                ...
                WHERE 
                    ...
                    sessionID = ?
            """, 
            (farmerID, deviceDetails, sessionID)
        )
